...
// 自己unitId
	...
	[Message(OuterOpcode.A2C_Disconnected)]
	[ProtoContract]
	public partial class A2C_Disconnected: Object, IMessage
	{
		[ProtoMember(1)]
		public int Error { get; set; }
	...
	[ResponseType(nameof(A2C_GetRelamKey))]
	[Message(OuterOpcode.C2A_GetRelamKey)]
	[ProtoContract]
	public partial class C2A_GetRelamKey: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.A2C_GetRelamKey)]
	[ProtoContract]
	public partial class A2C_GetRelamKey: Object, IResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
		...
		[ProtoMember(2)]
		public string RelamAddress { get; set; }

	}

	[ResponseType(nameof(R2C_LoginRelam))]
	[Message(OuterOpcode.C2R_LoginRelam)]
	[ProtoContract]
	public partial class C2R_LoginRelam: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }

		[ProtoMember(1)]
		public string RelamTokenKey { get; set; }
	...
	[Message(OuterOpcode.R2C_LoginRelam)]
	[ProtoContract]
	public partial class R2C_LoginRelam: Object, IResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
