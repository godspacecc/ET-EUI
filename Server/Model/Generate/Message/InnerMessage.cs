...
namespace ET
{
	...
	[ResponseType(nameof(R2A_GetRelamKey))]
	[Message(InnerOpcode.A2R_GetRelamKey)]
	[ProtoContract]
	public partial class A2R_GetRelamKey: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.R2A_GetRelamKey)]
	[ProtoContract]
	public partial class R2A_GetRelamKey: Object, IActorResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
		...
		[ProtoMember(1)]
		public string RelamKey { get; set; }
	...
	[ResponseType(nameof(M2G_RequsetEnterGameState))]
	[Message(InnerOpcode.G2M_RequsetEnterGameState)]
	[ProtoContract]
	public partial class G2M_RequsetEnterGameState: Object, IActorLocationRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.M2G_RequsetEnterGameState)]
	[ProtoContract]
	public partial class M2G_RequsetEnterGameState: Object, IActorLocationResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ResponseType(nameof(M2G_RequsetExitGame))]
	[Message(InnerOpcode.G2M_RequsetExitGame)]
	[ProtoContract]
	public partial class G2M_RequsetExitGame: Object, IActorLocationRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.M2G_RequsetExitGame)]
	[ProtoContract]
	public partial class M2G_RequsetExitGame: Object, IActorLocationResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
