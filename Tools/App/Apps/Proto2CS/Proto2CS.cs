...
namespace ET
{
    ...
    public static class InnerProto2CS
    {
        ...
        public static void Proto2CS()
        {
            ...
            Proto2CS("ET", "../Proto/OuterAccountMessage.proto", clientMessagePath, "OuterAccountOpcode", OpcodeRangeDefine.OuterMinOpcode);
            GenerateOpcode("ET", "OuterAccountOpcode", clientMessagePath);
        }
